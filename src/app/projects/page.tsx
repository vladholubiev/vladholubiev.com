...
const projects: Project[] = [
  {
    name: 'klats.shop',
    description:
      'Premium glove brand storefront with a fashion-editorial feel.',
  ...
  },
  {
    ...
    link: {
      href: 'https://github.com/shelfio/aws-lambda-libreoffice',
      label: 'github.com',
    },
  },
  {
  ...
  },
  {
    ...
    link: {
      href: 'https://github.com/shelfio/jest-mongodb',
      label: 'github.com',
    },
  },
  {
    ...
    link: {
      href: 'https://github.com/shelfio/jest-dynamodb',
      label: 'github.com',
    },
  },
  {
    ...
    link: {
      href: 'https://github.com/shelfio/chrome-aws-lambda-layer',
      label: 'github.com',
    },
  },
  {
    ...
    link: {
      href: 'https://github.com/shelfio/dynamodb-parallel-scan',
      label: 'github.com',
    },
  },
];
          ...
          <Card as="li" key={project.name} className="h-full">
            <div className="flex h-full flex-col">
              ...
              <p className="group-hover:text-ua-blue-500 dark:group-hover:text-ua-blue-300 relative z-10 mt-auto flex items-center gap-2 pt-6 text-sm font-medium text-zinc-400 transition dark:text-zinc-200">
                {project.icon === 'voice' ? (
                  <Mic className="h-6 w-6 flex-none" strokeWidth={1.5} />
                ) : (
                  <Link className="h-6 w-6 flex-none" strokeWidth={1.5} />
                )}
