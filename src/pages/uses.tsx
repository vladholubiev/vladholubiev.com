        ...
        <div className="space-y-20">
          <ToolsSection title="Workstation">
            ...
            <Tool title="Logitech Ergo K860">
              ...
              design. Its split layout, cushioned wrist rest, and negative tilt significantly
              reduced wrist strain and improved typing comfort during long coding sessions.
            </Tool>
            <Tool title="Logitech MX Vertical">
              Recently upgraded from the Logitech MX Master 3 to the Logitech MX Vertical for its
              ergonomic design. The vertical orientation helps reduce wrist strain and promotes a
              more natural hand position, providing greater comfort during extended periods of work.
            </Tool>
          </ToolsSection>
          <ToolsSection title="Development tools">
            ...
            <Tool title="CleanShot X">
              After trying many different screenshot tools, this is the only one that meets all of
              my needs. It struck me with beautiful annotation tools, auto-scroll screenshots, and
              decent screen recording features.
            </Tool>
          </ToolsSection>
          <ToolsSection title="Productivity">
            <Tool title="AI-powered coding tools (Claude Code, OpenAI Codex, GitHub Copilot Agent)">
              I&apos;m always exploring the cutting-edge in AI coding assistants. My current
              favorites include OpenAI Codex, Claude Code. This space evolves rapidly, so the list
              is always changing.
            </Tool>
            <Tool title="DevUtils">
          ...
          <ToolsSection title="Newsletters">
            <Tool title="ByteByteGo" href="https://blog.bytebytego.com/">
              It covers interesting bits of software architecture and distributed systems. I like
              how they explain complex topics in a simple way.
            </Tool>
            ...
            <Tool title="TypeScript Weekly" href="https://typescript-weekly.com/">
              TypeScript releases are pretty technical, so I am always on a lookout for good
              follow-up articles in this newsletter.
            </Tool>
          </ToolsSection>
        </div>
      </SimpleLayout>
