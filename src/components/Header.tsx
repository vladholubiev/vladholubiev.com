  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="from-ua-blue-500/0 via-ua-blue-500/40 to-ua-blue-500/0 dark:from-ua-blue-400/0 dark:via-ua-blue-400/40 dark:to-ua-blue-400/0 absolute inset-x-1 -bottom-px h-px bg-linear-to-r" />
        )}
      </Link>
    </li>
  );
...
function ModeToggle() {
  ...
  return (
    <button
      ...
      onClick={toggleMode}
    >
      <SunIcon className="[@media(prefers-color-scheme:dark)]:stroke-ua-blue-500 [@media(prefers-color-scheme:dark)]:group-hover:stroke-ua-blue-600 h-6 w-6 fill-zinc-100 stroke-zinc-500 transition group-hover:fill-zinc-200 group-hover:stroke-zinc-700 dark:hidden [@media(prefers-color-scheme:dark)]:fill-teal-50 [@media(prefers-color-scheme:dark)]:group-hover:fill-teal-50" />
      <MoonIcon className="not-[@media_(prefers-color-scheme:dark)]:stroke-ua-blue-500 hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition not-[@media_(prefers-color-scheme:dark)]:fill-teal-400/10 dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400" />
    </button>
  );
}
