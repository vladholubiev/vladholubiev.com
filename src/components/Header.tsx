  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-linear-to-r from-ua-blue-500/0 via-ua-blue-500/40 to-ua-blue-500/0 dark:from-ua-blue-400/0 dark:via-ua-blue-400/40 dark:to-ua-blue-400/0" />
        )}
      </Link>
    </li>
  )
...
function ModeToggle() {
  ...
  return (
    ...
    >
      ...
      <MoonIcon className="hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400 not-[@media_(prefers-color-scheme:dark)]:fill-teal-400/10 not-[@media_(prefers-color-scheme:dark)]:stroke-ua-blue-500" />
    </button>
  )
}
